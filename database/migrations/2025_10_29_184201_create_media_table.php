...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('media', function (Blueprint $table) {
            ...
            $table->foreignId('uploaded_by')->nullable()->constrained('users')->onDelete('set null'); // Who uploaded (replaces created_by)
            $table->foreignId('updated_by')->nullable()->constrained('users')->onDelete('set null'); // Who last updated
            $table->foreignId('deleted_by')->nullable()->constrained('users')->onDelete('set null'); // Who deleted
