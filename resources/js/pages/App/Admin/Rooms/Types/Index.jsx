        ...
        <>
            ...
            >
                <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <Box>
                        <Button variant="outlined" startIcon={<RestoreFromTrash />} sx={{ color: '#063455', borderColor: '#063455', borderRadius: '16px', height: 35, textTransform: 'none', marginRight: 2 }} onClick={() => router.visit(route('room-types.trashed'))}>
                            View Trash
                        </Button>
