                    ...
                    <CardContent>
                        ...
                        <Box bgcolor="grey.300" p={1} my={2}>
                            <Grid container justifyContent="space-between">
                                <Typography fontWeight="bold">Total Charges (Base):</Typography>
                        ...
                        <Box bgcolor="grey.400" p={1} my={2}>
                            <Grid container justifyContent="space-between">
                                <Typography fontWeight="bold">Grand Total (Per Invoice):*</Typography>
                        ...
                        <Box mt={4} display="flex" gap={2}>
                            <Button variant="contained" color="primary" onClick={() => handleSubmit('save')} disabled={storing}>
                                {storing ? 'SAVING...' : 'SAVE'}
                            </Button>
                            <Button variant="contained" color="info" onClick={() => handleSubmit('save_print')} disabled={storing}>
                                SAVE & PRINT
                            </Button>
                            <Button variant="contained" color="secondary" onClick={handlePreview} disabled={storing || previewLoading}>
                                {previewLoading ? 'LOADING...' : 'PREVIEW'}
                            </Button>
                            <Button variant="contained" color="inherit" onClick={() => window.history.back()}>
                                CANCEL
                            </Button>
                        </Box>
                    </CardContent>
