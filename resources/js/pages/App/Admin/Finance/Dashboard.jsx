                                                    ...
                                                    return (
                                                        <TableRow key={transaction.id} style={{ borderBottom: '1px solid #eee' }}>
                                                            ...
                                                            <TableCell sx={{ color: '#7F7F7F', fontWeight: 400, fontSize: '14px', whiteSpace: 'nowrap' }}>
                                                                <div>
                                                                    <Tooltip title={transaction.member?.full_name || transaction.customer?.name || transaction.invoiceable?.name || 'N/A'}>
                                                                        ...
                                                                        >
                                                                            {transaction.member?.full_name || transaction.customer?.name || transaction.invoiceable?.name || 'N/A'}
                                                                        </div>
                                                                    </Tooltip>
                                                            ...
                                                            <TableCell sx={{ color: '#7F7F7F', fontWeight: 500, fontSize: '14px' }}>
                                                                <Tooltip title={transaction.total_price?.toLocaleString() || transaction.amount?.toLocaleString() || 0}>
                                                                    <div
                                                                        style={{
                                                                            fontWeight: 400,
                                                                            color: '#7f7f7f',
