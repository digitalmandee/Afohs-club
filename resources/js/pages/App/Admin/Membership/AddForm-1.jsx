                ...
                <div style={{ backgroundColor: "#f5f5f5", minHeight: "100vh", padding: "20px", }}>
                                    ...
                                    <Grid item xs={12}>
                                        <Box sx={{ mb: 1, display: "flex", gap: "10px", }}>
                                            ...
                                            >
                                                ...
                                                {memberImage ? (
                                                    <img
                                                        src={memberImage || "/placeholder.svg"}
                                                        alt="Member"
                                                        style={{ width: "100%", height: "100%", objectFit: "cover" }}
                                                    />
                                                ) : (
                                                    <Add sx={{ color: "#a5d8ff", fontSize: 30 }} />
                                                )}
                                    ...
                                    <Grid item xs={6}>
                                        ...
                                        <FormControl fullWidth size="small">
                                            <Select
                                                ...
                                                IconComponent={() => (
                                                    <KeyboardArrowDown sx={{ position: "absolute", right: 8, pointerEvents: "none" }} />
                                                )}
                                            >
                                ...
                                <Grid item xs={12} md={6} container spacing={3}>
                                    ...
                                    <Grid item xs={6}>
                                        ...
                                        <TextField
                                            fullWidth
                                            variant="outlined"
                                            placeholder="Enter Nationality e.g. Pakistan"
                                            size="small"
                                            sx={{ "& .MuiOutlinedInput-root": { borderRadius: "4px" } }}
                                        />
                                    </Grid>
                                    ...
                                    <Grid item xs={6}>
                                        ...
                                        <TextField
                                            fullWidth
                                            variant="outlined"
                                            placeholder="Enter national ntn number"
                                            size="small"
                                            sx={{ "& .MuiOutlinedInput-root": { borderRadius: "4px" } }}
                                        />
                                    </Grid>
                    ...
                    <Box sx={{ display: "flex", justifyContent: "flex-end", gap: 2 }}>
                        ...
                        <Button
                            ...
                            onClick={()=>router.visit('/admin/add/contact/information')}
                        >
                            Save & Next
                        </Button>
                    </Box>
