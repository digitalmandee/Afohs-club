            ...
            <div className="mx-3">
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                        ...
                        <Typography sx={{ fontWeight: 600, fontSize: '24px', color: '#063455' }}>Deleted Applied Members</Typography>
                    </Box>
                    ...
                    <Table>
                        <TableHead>
                            <TableRow style={{ backgroundColor: '#E5E5EA', height: '60px' }}>
                                ...
                                <TableCell sx={{ color: '#000000', fontSize: '14px', fontWeight: 600 }}>Phone</TableCell>
