                    ...
                    <Card sx={{ mb: 3 }}>
                        <CardContent>
                            ...
                            <Grid container spacing={2} alignItems="center">
                                ...
                                <Grid item xs={12} md={2}>
                                    <TextField fullWidth label="From Date" type="date" value={localFilters.date_from} onChange={(e) => handleFilterChange('date_from', e.target.value)} InputLabelProps={{ shrink: true }} />
                                </Grid>

                                <Grid item xs={12} md={2}>
                                    <TextField fullWidth label="To Date" type="date" value={localFilters.date_to} onChange={(e) => handleFilterChange('date_to', e.target.value)} InputLabelProps={{ shrink: true }} />
                                </Grid>
