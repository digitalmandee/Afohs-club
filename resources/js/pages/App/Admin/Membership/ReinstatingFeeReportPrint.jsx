...
export default function ReinstatingFeeReportPrint({ transactions, statistics, filters, all_categories }) {
    useEffect(() => {
                ...
                <table>
                    ...
                    <tbody>
                        {transactions?.data && transactions.data.length > 0 ? (
                            ...
                            <tr>
                                <td colSpan="8" className="text-center">No reinstating fee records found</td>
                            </tr>
                        )}
