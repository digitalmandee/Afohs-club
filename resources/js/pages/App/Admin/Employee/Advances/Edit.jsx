                ...
                <Card sx={{ borderRadius: '12px', p: 3 }}>
                    <form onSubmit={handleSubmit}>
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12} sm={6}>
                                <TextField fullWidth type="date" label="Advance Date *" value={formData.advance_date} onChange={(e) => handleChange('advance_date', e.target.value)} InputLabelProps={{ shrink: true }} />
                            </Grid>
                            <Grid item xs={12} sm={6}>
                            ...
                            <Grid item xs={12} sm={4}>
                                <TextField fullWidth type="date" label="Deduction Start Date" value={formData.deduction_start_date} onChange={(e) => handleChange('deduction_start_date', e.target.value)} InputLabelProps={{ shrink: true }} />
                            </Grid>
                            <Grid item xs={12} sm={4}>
