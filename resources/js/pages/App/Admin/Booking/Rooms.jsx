                ...
                <Box sx={{ p: 1, mt: 3, maxHeight: 'calc(100vh - 120px)', overflowY: 'auto' }}>
                    {availableRooms.map((room, index) => (
                        ...
                        >
                            <Row
                                ...
                                onClick={() => router.visit(route('rooms.booking'))}
                            >
                                <Col xs={3}>
                                    <img src={room.image || '/placeholder.svg'} alt={room.type} style={{ width: 100, height: 67, borderRadius: '4px' }} />
                                </Col>
                                <Col xs={9}>
                    ...
                    {availableEvents.map((event, index) => (
                        ...
                        >
                            <Row>
                                <Col xs={3}>
                                    <img src={event.image || '/placeholder.svg'} alt={event.name} style={{ width: 100, height: 67, borderRadius: '4px' }} />
                                </Col>
                                <Col xs={9}>
