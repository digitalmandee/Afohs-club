                                                                ...
                                                                <TableRow key={transaction.id}>
                                                                        ...
                                                                        {transaction.items && transaction.items.length > 0 ? (
                                                                                ...
                                                                                {transaction.items.map((item, idx) => {
                                                                                    ...
                                                                                    return (
                                                                                        <Chip
                                                                                            ...
                                                                                            color="primary"
                                                                                            size="small"
                                                                                            sx={{ bgcolor: '#063455', textTransform: 'capitalize', maxWidth: 'fit-content' }}
                                                                                        />
                                                                                    );
                                                                                })}
                                                                            </Box>
                                                                            ...
                                                                            transaction.fee_type && transaction.fee_type.trim() !== '' ? (
                                                                                <Chip
                                                                                    ...
                                                                                    color={transaction.fee_type === 'membership_fee' ? 'primary' : transaction.fee_type === 'subscription_fee' ? 'success' : 'secondary'}
                                                                                    size="small"
                                                                                    sx={{ bgcolor: '#063455', textTransform: 'capitalize' }}
                                                                                />
                                                                            ) : null  // Show NOTHING when fee_type is empty/null
                                                                        )}
                                                                    </TableCell>
                                                                    ...
                                                                    <TableCell>
                                                                        <Button
                                                                            ...
                                                                            sx={{ py: 0.5, px: 1, color: '#063455', bgcolor: 'transparent', border: '1px solid #063455', textTransform: 'none' }}
                                                                        >
                                                                            View
                                                                        </Button>
                                                                    </TableCell>
                                                                    <TableCell sx={{ whiteSpace: 'nowrap' }}>
                                                                        {transaction.status === 'unpaid' && (
                                                                            <Button size="small" variant="contained" color="success" startIcon={<Payment />} onClick={() => handlePayClick(transaction)} sx={{ py: 0.5, px: 1, whiteSpace: 'nowrap', textTransform: 'none' }}>
                                                                                Pay Now
                                                                            </Button>
                                                                        )}
