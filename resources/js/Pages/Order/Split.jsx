    ...
    const customers = [
        {
            id: 1,
            items: [
                { name: 'Cappuccino', price: 4.00, quantity: 1, totalPrice: 5.00, discount: null },
                { name: 'Soda Beverage', price: 5.00, quantity: 2, totalPrice: 10.00, discount: null },
                { name: 'French Toast Sugar', price: 4.00, quantity: 2, totalPrice: 8.00, discount: 50 },
                { name: 'Chocolate Croissant', price: 5.00, quantity: 1, totalPrice: 5.00, discount: null }
            ],
            subtotal: 20.00,
            discount: { percent: 5, amount: 0.00 },
        ...
        },
        {
            ...
            items: [
                { name: 'Cappuccino', price: 4.00, quantity: 1, totalPrice: 5.00, discount: null },
                { name: 'Soda Beverage', price: 5.00, quantity: 1, totalPrice: 5.00, discount: null },
                { name: 'Chocolate Croissant', price: 5.00, quantity: 1, totalPrice: 5.00, discount: null },
                { name: 'French Toast Sugar', price: 4.00, quantity: 1, totalPrice: 4.00, discount: 50 }
            ],
            total: 16.72
        }
    ];
