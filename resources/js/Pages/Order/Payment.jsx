                ...
                >
                    ...
                    <Grid container spacing={1} sx={{ mb: 2 }}>
                        <Grid item xs={6}>
                            <Typography
                                variant="body2"
                                sx={{ fontWeight: "bold", color: "#0a4b78" }}
                            >
                                Total Amount
                            </Typography>
                        </Grid>
                    ...
                    <Typography
                        variant="caption"
                        sx={{ color: "#666", mb: 2, fontSize: "0.65rem" }}
                    >
                        Thanks for having our passion. Drop by again. If your
                        orders aren't still visible, you're always welcome here!
                    </Typography>
