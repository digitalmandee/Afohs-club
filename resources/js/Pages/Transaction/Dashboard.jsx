                ...
                <div style={styles.root}>
                    ...
                    >
                        <Box sx={{ p: 3 }}>
                            ...
                            {/* Order Type Section */}
                            <Box className={styles.filterSection} sx={{
                                mb: 3,
                                border: "1px solid #eee",
                                borderRadius: "8px",
                                p: 2,
                                    ...
                                    <Box sx={{ mb: 1 }}>
                                        <Box display="flex" flexWrap="wrap" gap={1}>
                                            {[
                                                ...
                                                { label: "Dine In", value: "dine-in", icon: <DiningIcon /> },
                                                { label: "Pick Up", value: "pickup", icon: <TakeoutIcon /> },
                                                { label: "Delivery", value: "delivery", icon: <DeliveryIcon /> },
                                                { label: "Takeaway", value: "takeaway", icon: <TakeoutIcon /> },
                                                { label: "Reservation", value: "reservation", icon: <ReservationIcon /> }
                                            ].map((item) => (
                                                <Chip
                                                    key={item.value}
                                                    label={item.label}
                            ...
                            <Box className={styles.filterSection} sx={{
                                ...
                                <Box className={styles.filterHeader} onClick={() => toggleSection("orderStatus")} sx={{ p: 0, mb: 1, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                                    ...
                                    <Box sx={{ mb: 1 }}>
                                        <Box display="flex" flexWrap="wrap" gap={1}>
                                            ...
                                            <Chip
                                                ...
                                                icon={<CheckCircleIcon style={{ color: filters.orderStatus === "ready" ? "white" : "#003049" }} />}
                                            />
                                            <Chip
                                                ...
                                                icon={<RestaurantIcon style={{ color: filters.orderStatus === "cooking" ? "white" : "#003049" }} />}
                                            />
                                            <Chip
                                                ...
                                                icon={<ReceiptIcon style={{ color: filters.orderStatus === "waiting" ? "white" : "#003049" }} />}
                                            />
                                            <Chip
                                                label="Order done"
                                                ...
                                                icon={<CheckCircleIcon style={{ color: filters.orderStatus === "done" ? "white" : "#003049" }} />}
                                            />
                                            <Chip
                                                ...
                                                icon={<CloseIcon style={{ color: filters.orderStatus === "cancelled" ? "white" : "#003049" }} />}
                                            />
                                        </Box>
                                    </Box>
                                </Collapse>
                            ...
                            <Box className={styles.filterSection} sx={{
                                ...
                                <Box className={styles.filterHeader} onClick={() => toggleSection("memberStatus")} sx={{ p: 0, mb: 1, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                                    ...
                                    <Box sx={{ mb: 1 }}>
                                        <Box display="flex" flexWrap="wrap" gap={1}>
                                            ...
                                            <Chip
                                                ...
                                                icon={<DiamondIcon style={{ color: filters.memberStatus === "diamond" ? "white" : "#003049" }} />}
                                            />
                                        </Box>
                                    </Box>
                                </Collapse>
                    ...
                    >
                        <Box sx={{ display: "flex", height: "100vh" }}>
                            ...
                            <Box sx={{ flex: 1, p: 3 }}>
                                ...
                                {/* Payment Method Tabs */}
                                <Box sx={{ display: "flex", borderBottom: "1px solid #e0e0e0", mb: 3 }}>
                                    <Box
                                        sx={activePaymentMethod === "cash" ? styles.activePaymentMethodTab : styles.paymentMethodTab}
                                        onClick={() => handlePaymentMethodChange("cash")}
                                    >
                                        <CreditCardIcon
                                            sx={{ fontSize: 24, mb: 1, color: activePaymentMethod === "cash" ? "#0a3d62" : "#666" }}
                                        />
                                    ...
                                    >
                                        <AccountBalanceIcon
                                            sx={{ fontSize: 24, mb: 1, color: activePaymentMethod === "bank" ? "#0a3d62" : "#666" }}
                                        />
