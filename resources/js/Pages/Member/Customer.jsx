...
import { Box, Typography, Drawer, TextField, Button, Grid, Paper, Avatar, InputAdornment } from "@mui/material"
                    ...
                    <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 3 }}>
                        <Box sx={{ display: "flex", alignItems: "center" }}>
                            <Typography variant="h5" fontWeight="500"
                                sx={{ mr: 1, color: '#3F4E4F', fontSize: '34px' }}>
                                780
                            </Typography>
                            <Typography variant="h5" fontWeight="500"
                                sx={{ mr: 3, color: '#7F7F7F', fontSize: '16px' }}>
                                Customers
                            </Typography>
                                ...
                                >
                                    ...
                                    <Box sx={{ mb: 1 }}>
                                        ...
                                        <Typography variant="body2" sx={{
                                            color: '#121212',
                                            fontSize: '14px'
                                        }}>{customer.favoriteDish}</Typography>
                                    </Box>
