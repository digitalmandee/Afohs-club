...
import { Edit, Close, ExpandMore, Star, ArrowForward, KeyboardArrowRight, KeyboardArrowLeft } from "@mui/icons-material"
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={6}>
                            ...
                            <Typography variant="body2" sx={{
                                color: '#121212',
                                fontSize: '14px'
                            }}>dianne.russell@gmail.com</Typography>
                        </Grid>
                        <Grid item xs={6}>
                            <Typography variant="caption" color="#7F7F7F" sx={{
                                fontSize: '14px'
                ...
                <Box sx={{ mt: 2, p: 2, border: '1px solid #7F7F7F', borderRadius: '4px' }}>
                    ...
                    >
                        <Typography sx={{
                            ...
                            fontWeight: 500,
                            fontSize: '14px'
                        }}>Order Activity Monthly</Typography>
                        <Box sx={{ display: "flex", alignItems: "center" }}>
                            <IconButton size="small">
