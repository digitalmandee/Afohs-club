...
const SettingDashboard = () => {
    ...
    const handleDeletePaymentType = (id) => {
        setPaymentTypes(
            paymentTypes.filter((paymentType) => paymentType.id !== id)
        );
    };
    ...
    const handleFloorActiveChange = (id) => {
        setFloors(
            floors.map((floor) =>
                floor.id === id ? { ...floor, active: !floor.active } : floor
            )
        );
    };
    ...
    const handleAddFloor = () => {
        if (newFloorName.trim()) {
            setFloors([
                ...floors,
                { id: floors.length + 1, name: newFloorName, active: true },
            ]);
            setNewFloorName("");
            setIsAddingFloor(false);
        }
                                ...
                                <Grid item xs={12} md={6}>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <MenuItem value="Bandung">
                                                Bandung
                                            </MenuItem>
                                            <MenuItem value="Surabaya">
                                                Surabaya
                                            </MenuItem>
                                        </StyledSelect>
                                    </FormControl>
                                ...
                                >
                                    ...
                                    >
                                        <Switch
                                            edge="end"
                                            checked={
                                                notifications.orderFromMobileApp
                                            }
                                            onChange={handleNotificationChange(
                                                "orderFromMobileApp"
                                            )}
                    ...
                    >
                        ...
                        <DialogContent>
                            ...
                            <Accordion>
                                <AccordionSummary
                                    expandIcon={<ExpandMoreIcon />}
                                    aria-controls="self-order-content"
                                    id="self-order-header"
                                >
                        ...
                        <DialogContent sx={{ p: 0 }}>
                            <Box sx={{ display: "flex", mb: 3 }}>
                                <Button
                                    ...
                                    onClick={() =>
                                        setTableManagementTab("floor-data")
                                    }
                                    sx={{
                                        py: 2,
                                        borderRadius: 0,
                                ...
                                <Button
                                    fullWidth
                                    variant={
                                        tableManagementTab === "area-data"
                                            ? "contained"
                                            : "outlined"
                                    }
                                    onClick={() =>
                                        setTableManagementTab("area-data")
                                    }
                                    sx={{
                                        py: 2,
                                        borderRadius: 0,
                            ...
                            {tableManagementTab === "floor-data" ? (
                                ...
                                <Box sx={{ p: 3 }}>
                                    <Typography variant="body1">
                                        Area Data content would go here.
                                    </Typography>
                                </Box>
                            )}
                        </DialogContent>
                                    ...
                                    >
                                        ...
                                        <ListItemSecondaryAction>
                                            <Switch
                                                ...
                                                onChange={() =>
                                                    handlePrintingDeviceActiveChange(
                                                        device.id
                                                    )
                                                }
                                                color="primary"
                    ...
                    {settingsOptions
                        ...
                        .map((option) => (
                            ...
                            >
                                ...
                                <DialogContent>
                                    <Typography>
                                        {option.title} settings content would go
                                        here.
                                    </Typography>
                                </DialogContent>
                                <DialogActions
